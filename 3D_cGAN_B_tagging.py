...
plt.hist(ld, bins = 75, color = 'blue')
plt.title("MuonPt")
plt.xlim(0,200)
...
print("Length of the array : ", len(b_tag), ", number of non-zero b-tagged events : ", cnt, ", ratio : ", cnt/len(b_tag))
...
def train(epochs, batch_size=128):
    ...
    for epoch in tqdm(range(epochs)):
        ...
        learning_rate = clr(epoch, step_size= 4000, base_lr = 0.00005, max_lr=0.1, mode='triangular2') #2000, 0.001, 0.06, t2
...
h2, xedges2, yedges2 = np.histogram2d(arg, arg11, bins=(100, 100), range=[[0, 80], [0, 30]])
h3, xedges3, yedges3 = np.histogram2d(arg1, arg11, bins=(100, 100), range=[[70, 110], [0, 30]])
...
h2_plot = axs[1].hist2d(arg, arg11, bins=(100, 100), range=[[0, 80], [0, 30]], cmap=plt.cm.rainbow, alpha=1, vmin=vmin, vmax=vmax)
...
h3_plot = axs[2].hist2d(arg1, arg11, bins=(100, 100), range=[[70, 110], [0, 30]], cmap=plt.cm.rainbow, alpha=1, vmin=vmin, vmax=vmax)
axs[2].set_xlabel(keys_f[1])
axs[2].set_ylabel(keys_f[2])
fig.colorbar(h3_plot[3], ax=axs[2])
...
# Plot 2D histogram for the first pair of variables
h1_plot = axs[0].hist2d(arg, arg11, bins=(80, 80), range=[[0, 80], [0, 30]], cmap=plt.cm.rainbow, alpha=1, vmin=vmin, vmax=vmax)
axs[0].set_xlabel(keys_f[0], fontsize=12)
axs[0].set_ylabel(keys_f[1], fontsize=12)
axs[0].set_title("Outputs", fontsize=15)
fig.colorbar(h1_plot[3], ax=axs[0])
...
# Plot 2D histogram for the second pair of variables
h2_plot = axs[1].hist2d(arg2, arg211, bins=(80, 80), range=[[0, 80], [0, 30]], cmap=plt.cm.rainbow, alpha=1, vmin=vmin, vmax=vmax)
axs[1].set_xlabel(keys_f[0], fontsize=12)
axs[1].set_ylabel(keys_f[1], fontsize=12)
axs[1].set_title("Inputs", fontsize=15)
fig.colorbar(h2_plot[3], ax=axs[1])
...
# Plot 2D histogram for the first pair of variables
h1_plot = axs[0].hist2d(arg1, arg11, bins=(80, 80), range=[[50, 130], [0, 30]], cmap=plt.cm.rainbow, alpha=1, vmin=vmin, vmax=vmax)
axs[0].set_xlabel(keys_f[0], fontsize=12)
axs[0].set_ylabel(keys_f[1], fontsize=12)
axs[0].set_title("Outputs", fontsize=15)
fig.colorbar(h1_plot[3], ax=axs[0])
...
# Plot 2D histogram for the second pair of variables
h2_plot = axs[1].hist2d(arg21, arg211, bins=(80, 80), range=[[50, 130], [0, 30]], cmap=plt.cm.rainbow, alpha=1, vmin=vmin, vmax=vmax)
axs[1].set_xlabel(keys_f[0], fontsize=12)
axs[1].set_ylabel(keys_f[1], fontsize=12)
axs[1].set_title("Inputs", fontsize=15)
fig.colorbar(h2_plot[3], ax=axs[1])
